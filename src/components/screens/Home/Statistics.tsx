...
const Statistics = observer(() => {
  ...
  return (
    <Card style={styles.container}>
      ...
      <Card.Content>
        <List.Item
          title={formatValue(store.statistics?.users)}
          description={t('stats.users')}
          left={props => <List.Icon {...props} icon="account-group" />}
          style={styles.itemStyle}
        />
        <List.Item
          title={formatValue(store.statistics?.openTrees)}
          description={t('stats.trees')}
          left={props => <List.Icon {...props} icon="pine-tree" />}
          style={styles.itemStyle}
        />
        <List.Item
          title={formatValue(store.statistics?.stories)}
          description={t('stats.stories')}
          left={props => <List.Icon {...props} icon="book-open-variant" />}
          style={styles.itemStyle}
        />
        <List.Item
          title={formatValue(store.statistics?.sentences)}
